...
<div class="container" style="margin-top:20px; width: 100%;">
	<center>
		<font size="6">Data Pelayanan</font>
	</center>
	<hr>
		...
		<table class="table table-striped jambo_table bulk_action" ; style="text-align:center">
			<thead>
				<tr style="line-height:15px;">
					...
					<th style="vertical-align:middle">Pelayanan</th>				
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td style="vertical-align:middle">'.$data['pelayanan'].'</td>
							<td style="vertical-align:middle">'.$data['periodepelayanan'].'</td>
							<td style="vertical-align:middle">'.$data['tempatpelayanan'].'</td>
							<td style="vertical-align:middle">'.$data['keteranganpelayanan'].'</td>
