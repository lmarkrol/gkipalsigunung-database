					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td style="vertical-align:middle">
								<a href="index.php?page=edit_jemaat&nomorinduk='.$data['nomorinduk'].'" class="btn btn-secondary btn-sm">Edit</a>
								<a href="jemaat_hapus.php?nomorinduk='.$data['nomorinduk'].'" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
						$no++;
