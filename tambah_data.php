<?php include('config.php'); ?>
		...
		if(isset($_POST['submit'])){
			...
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO personal(nomorinduk, statusjemaat, namalengkap, jeniskelamin, sukuetnis, tempatlahir, tanggallahir, golongandarah, rhesus, alamat, wilayah, kelompok, namaadmin) VALUES('$nomorinduk', '$statusjemaat', '$namalengkap', '$jeniskelamin', '$sukuetnis', '$tempatlahir', '$tanggallahir', '$golongandarah', '$rhesus', '$alamat', '$wilayah', '$kelompok', '$namaadmin')") or die(mysqli_error($koneksi));
